...
Service({
  ...
  "listProductsByBrand": Func([Text], [Vec(Product)], ["query"]),
  ...
  "updateOrderStatus": Func([OrderId, OrderStatus], [Bool], []),
  "upsertProduct": Func([ProductInput], [], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const Product2 = IDL2.Record({
    ...
    "isLimited": IDL2.Bool,
    "category": IDL2.Text,
    "badge": IDL2.Opt(IDL2.Text),
    "brand": IDL2.Text,
    "imagePaths": IDL2.Vec(IDL2.Text),
    "priceInCents": IDL2.Nat
  });
  ...
  return IDL2.Service({
    ...
    "confirmPayment": IDL2.Func([IDL2.Text], [IDL2.Bool], []),
    ...
    "listProductsByBrand": IDL2.Func([IDL2.Text], [IDL2.Vec(Product2)], ["query"]),
    ...
    "submitOrderRequest": IDL2.Func(
      ...
      [IDL2.Variant({ "ok": OrderId2, "err": IDL2.Text })],
      []
    ),
    "transform": IDL2.Func(
    ...
    "updateOrderStatus": IDL2.Func([OrderId2, OrderStatus2], [IDL2.Bool], []),
    "upsertProduct": IDL2.Func([ProductInput2], [], [])
  });
};
...
class Backend {
  ...
  async submitOrderRequest(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
    if (this.processError) {
      try {
