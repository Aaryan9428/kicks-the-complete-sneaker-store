import { R as React, j as jsxRuntimeExports, m as motion, r as reactExports, f as useNavigate, L as Link, u as ue } from "./index-EDhnjgOJ.js";
import { u as useActor, c as createActor } from "./backend-C4U0oltt.js";
import { c as createLucideIcon, k as createSlot, a as cn, u as useCartStore, L as Layout, j as ShoppingBag, B as Button, A as AnimatePresence } from "./button-B4gG1HGM.js";
import { S as Smartphone, C as CircleCheck, B as Banknote } from "./smartphone-DSZYQ7lR.js";
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-full bg-red-500/20 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Smartphone, { className: "w-4 h-4 text-red-400" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold bg-gradient-to-r from-red-400 to-rose-300 bg-clip-text text-transparent text-base tracking-wide", children: "Scan to Pay via UPI" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 rounded-xl bg-[#0d0d0d] border border-red-500/20 shadow-[0_0_30px_rgba(239,68,68,0.1)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            QRCodeSVG,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 uppercase tracking-widest", children: "UPI ID" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 uppercase tracking-widest", children: "Amount to Pay" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px bg-gradient-to-r from-transparent via-red-500/20 to-transparent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-600 mt-2", children: "Opens your UPI app directly on mobile" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
...
const inputClass = "bg-gray-900 border border-gray-700 focus:border-red-500 focus:ring-1 focus:ring-red-500/30 rounded-lg px-4 py-3 text-sm text-white placeholder:text-gray-500 transition-colors outline-none w-full";
function Checkout() {
  ...
  const handlePlaceOrder = async () => {
    ...
    if (paymentMethod === "phonepe" && !phonepePaid) {
      ue.error("Please confirm you have completed the UPI payment");
      return;
    }
    if (!actor) {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto max-w-7xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            className: "mb-10",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-semibold tracking-[0.25em] uppercase bg-gradient-to-r from-red-400 to-rose-300 bg-clip-text text-transparent mb-2", children: "Secure Checkout" }),
              ...
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-white flex items-center gap-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-4 h-4 text-red-400" }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        className: `w-full rounded-xl border-2 p-4 text-left transition-all duration-200 ${paymentMethod === "cod" ? "border-red-500 bg-red-500/10 shadow-[0_0_20px_rgba(239,68,68,0.2)]" : "border-gray-700 bg-gray-900/50 hover:border-gray-500"}`,
                        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: `w-10 h-10 rounded-full flex items-center justify-center ${paymentMethod === "cod" ? "bg-red-500/20" : "bg-gray-800"}`,
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                Banknote,
                                {
                                  className: `w-5 h-5 ${paymentMethod === "cod" ? "text-red-400" : "text-gray-400"}`
                                }
                              )
                            }
                          ),
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: `w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 ${paymentMethod === "cod" ? "border-red-500 bg-red-500" : "border-gray-600"}`,
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        className: `w-full rounded-xl border-2 p-4 text-left transition-all duration-200 ${paymentMethod === "phonepe" ? "border-red-500 bg-red-500/10 shadow-[0_0_20px_rgba(239,68,68,0.2)]" : "border-gray-700 bg-gray-900/50 hover:border-gray-500"}`,
                        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: `w-10 h-10 rounded-full flex items-center justify-center ${paymentMethod === "phonepe" ? "bg-red-500/20" : "bg-gray-800"}`,
                              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                                Smartphone,
                                {
                                  className: `w-5 h-5 ${paymentMethod === "phonepe" ? "text-red-400" : "text-gray-400"}`
                                }
                              )
                            }
                          ),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-white text-sm", children: "UPI Payment" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-wider px-2 py-0.5 rounded-full bg-red-500/20 text-red-400 border border-red-500/30", children: "Instant" })
                            ] }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 mt-0.5", children: "Pay instantly via UPI" })
                          ] }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              className: `w-5 h-5 rounded-full border-2 flex items-center justify-center shrink-0 ${paymentMethod === "phonepe" ? "border-red-500 bg-red-500" : "border-gray-600"}`,
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2 text-sm", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between font-bold text-base", children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-gradient-to-r from-red-400 to-rose-300 bg-clip-text text-transparent", children: fmt(total) })
                        ] })
                      ] })
                    ]
                  }
